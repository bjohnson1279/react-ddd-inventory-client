        ...
        <>
          <div className="anomaly-summary-cards">
            <div className="anomaly-summary-card critical">
              ...
              <div className="severity-count critical">
            ...
            <div className="anomaly-summary-card risk-gauge">
              ...
              <div
                ...
                style={{
                  border: `4px solid rgba(139,92,246,${data.overallRiskScore / 100})`,
                  color: "#a78bfa",
                }}
              >
                  ...
                  {data.actorRisks?.length ? (
                    data.actorRisks.map((actor: any, idx: number) => (
                      <div className="actor-risk-bar" key={idx}>
                        <div className="actor-risk-label" title={actor.actorId}>
                          {actor.actorId}
                        </div>
                        ...
                        <div className="actor-risk-score">
                          {actor.riskScore}
                        </div>
                      </div>
                    ))
      ...
      <div className="confidence-bar">
        <div
          ...
          style={{
            ...
            background: `linear-gradient(90deg, transparent, ${severityClass === "critical" ? "#ef4444" : severityClass === "high" ? "#f97316" : severityClass === "medium" ? "#eab308" : "#3b82f6"})`,
          }}
        ></div>
      </div>
      {expanded && alert.evidence && (
        <div className="alert-evidence">{alert.evidence}</div>
      )}
    </div>
  );
};
